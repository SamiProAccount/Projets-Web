...
<html lang="en">
  ...
  <!-- Font Awesome Icons -->
          <link rel="stylesheet" href="../admin/all.min.css">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="?page=livrelist" class="nav-link navlivre">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Livres </p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="?page=auteurlist" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p> Auteurs <span class="right badge badge-danger"> New </span> </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?page=editeurlist" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p> Editeurs <span class="right badge badge-danger"> New </span> </p>
            </a>
          </li>
          <li class="nav-item">
